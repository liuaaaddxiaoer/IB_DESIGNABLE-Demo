...
- (void)viewDidLoad {
    ...
    [self.tableView registerClass:[MyTableViewCell class] forCellReuseIdentifier:@"ids"];
...
//    [self configureCell:cell atIndexPath:indexPath];
    ...
    MyTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"ids"];
...
//            break;
//    }
    return [tableView fd_heightForCellWithIdentifier:@"ids" cacheByIndexPath:indexPath configuration:^(MyTableViewCell * cell) {
        cell.entity = self.feedEntitySections[0][indexPath.row];
    }];
}
